...
# To enter the university, a student must get at least 270 points in total
...
overall_scores = [a + b + c for a, b, c in zip(scores_maths, scores_physics, scores_english)]
